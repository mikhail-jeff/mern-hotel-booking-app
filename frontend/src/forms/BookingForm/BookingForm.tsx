...
const BookingForm = ({ currentUser, paymentIntent }: Props) => {
	...
	return (
		<form
			...
			className="grid grid-cols-1 gap-4 rounded-md border border-slate-300 p-5 shadow-md">
			<span className="text-2xl font-extrabold mb-3">Confirm Your Details</span>
			...
			<div className="flex justify-end">
				<button
					disabled={isLoading}
					className="bg-blue-600 rounded-md text-white p-2 font-bold hover:bg-blue-500 text-lg disabled:bg-gray-500">
